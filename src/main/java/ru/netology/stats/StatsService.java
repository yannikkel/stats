...
public class StatsService {
    ...
    public int statisticMonthUnderAverage(int[] sale) {
        ...
        // Запускаем цикл от 0 до длины  sale
        for (int i = 0; i < sale.length; i++) {
            // если значение меньше среднего, то увеличиваем numberUnderAverage на 1
    ...
    public int statisticMonthOverAverage(int[] sale) {
        ...
        // Запускаем цикл от 0 до длины  sale
        for (int i = 0; i < sale.length; i++) {
            // Если значение больше среднего, то увеличиваем  numberUnderAverage на 1
            if (sale[i] > averageSum) {
